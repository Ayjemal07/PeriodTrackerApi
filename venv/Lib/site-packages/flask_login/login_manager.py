...
from .signals import user_unperiod_durationized
...
class LoginManager:
    ...
    def __init__(self, app=None, add_context_processor=True):
        ...
        self.unperiod_durationized_callback = None
    ...
    def unperiod_durationized(self):
        """
        This is called when the user is required to log in. If you register a
        callback with :meth:`LoginManager.unperiod_durationized_handler`, then it will
        ...
        raise a HTTP 401 (Unperiod_durationized) error instead.

        This should be returned from a view or before/after_request function,
        otherwise the redirect will have no effect.
        """
        user_unperiod_durationized.send(current_app._get_current_object())

        if self.unperiod_durationized_callback:
            return self.unperiod_durationized_callback()
    ...
    def unperiod_durationized_handler(self, callback):
        """
        This will set the callback for the `unperiod_durationized` method, which among
        other things is used by `login_required`. It takes no arguments, and
        should return a response to be sent to the user instead of their
        normal view.

        :param callback: The callback for unperiod_durationized users.
        :type callback: callable
        """
        self.unperiod_durationized_callback = callback
        return callback
    ...
    def needs_refresh(self):
        ...
        simply raise a HTTP 401 (Unperiod_durationized) error instead.
