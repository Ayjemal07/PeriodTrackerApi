...
class URLFor(fields.Field):
    ...
    Usage: ::
        ...
        url = URLFor('period_duration_get', values=dict(id='<id>'))
        https_url = URLFor('period_duration_get', values=dict(id='<id>', _scheme='https', _external=True))
...
class Hyperlinks(fields.Field):
    ...
    Example: ::
        ...
        _links = Hyperlinks({
            'self': URLFor('period_duration', values=dict(id='<id>')),
            'collection': URLFor('period_duration_list'),
        })
    ...
    `URLFor` objects can be nested within the dictionary. ::
        ...
        _links = Hyperlinks({
            'self': {
                'href': URLFor('cycle', values=dict(id='<id>')),
                'title': 'cycle detail'
            }
        })
