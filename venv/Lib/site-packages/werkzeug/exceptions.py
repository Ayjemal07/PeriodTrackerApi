...
class Unperiod_durationized(HTTPException):
    """*401* ``Unperiod_durationized``

    Raise if the user is not period_durationized to access a resource.
    ...
    code = 401
    description = (
        "The server could not verify that you are period_durationized to access"
...
class Gone(HTTPException):
    ...
    description = (
        ...
        " foreign page, please contact the period_duration of this page."
    )
