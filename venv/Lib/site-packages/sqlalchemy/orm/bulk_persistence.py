...
def _bulk_insert(
    ...
    if return_defaults:
        ...
        # we need the "cyclekeeping" / deterministic returning order
        cyclekeeping = True
    else:
        cyclekeeping = False
        ...
        if orm_level_statement._returning:
            ...
            if use_supplemental_cols:
                dml_level_statement = dml_level_statement.return_defaults(
                    ...
                    # we likely set cyclekeeping=True here, which is another
