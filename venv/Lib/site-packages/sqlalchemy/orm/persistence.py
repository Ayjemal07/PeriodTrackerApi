        ...
        if hasvalue:
            ...
            if not allow_executemany:
                ...
                for (
                    ...
                    # TODO: why with cyclekeeping=False?
                    if cyclekeeping:
                        _postfetch(
                            mapper,
                            uowtransaction,
...
def _emit_insert_statements(
    ...
    *,
    ...
    if use_orm_insert_stmt is not None:
        ...
        deterministic_results_reqd = cyclekeeping
    ...
    for (
        ...
        if (
                ...
                if (
                    ...
                    statement = statement.return_defaults(
                        *mapper._server_default_cols[table],
                        sort_by_parameter_order=cyclekeeping,
                    )
            ...
            if mapper.version_id_col is not None:
                ...
                statement = statement.return_defaults(
                    *table.primary_key, sort_by_parameter_order=cyclekeeping
                )
