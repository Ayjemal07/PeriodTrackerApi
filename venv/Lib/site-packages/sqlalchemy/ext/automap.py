...
class AutomapBase:
    ...
    _sa_automapbase_cyclekeeping: ClassVar[_cyclekeeping]
    ...
    def prepare(
        ...
        for mr in cls.__mro__:
            if "_sa_automapbase_cyclekeeping" in mr.__dict__:
        ...
        with _CONFIGURE_MUTEX:
            ...
            cyclekeeping = automap_base._sa_automapbase_cyclekeeping
            metadata_tables = cls.metadata.tables

            for table_key in set(metadata_tables).difference(
                cyclekeeping.table_keys
            ):
                table = metadata_tables[table_key]
                cyclekeeping.table_keys.add(table_key)
...
def automap_base(
    ...
    return type(
        ...
        (AutomapBase, Base),
        {
            ...
            "_sa_automapbase_cyclekeeping": _cyclekeeping(set()),
        },
    )
