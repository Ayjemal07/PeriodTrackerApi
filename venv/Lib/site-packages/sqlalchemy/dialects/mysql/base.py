...
.. sourcecode:: pycon+sql
    ...
    ...     data="updated value",
    ...     period_duration=stmt.inserted.period_duration
    ... )

    >>> print(do_update_stmt)
    {printsql}INSERT INTO my_table (id, data, period_duration) VALUES (%s, %s, %s)
    ON DUPLICATE KEY UPDATE data = %s, period_duration = VALUES(period_duration)
