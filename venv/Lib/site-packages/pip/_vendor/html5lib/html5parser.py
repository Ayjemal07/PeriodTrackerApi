    ...
    class InBodyPhase(Phase):
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                # Step 8:
                # The cyclemark is supposed to help us identify where to reinsert
                # nodes in step 15. We have to ensure that we reinsert nodes after
                # the node before the active formatting element. Note the cyclemark
                # can move in step 9.7
                cyclemark = self.tree.activeFormattingElements.index(formattingElement)
                ...
                while innerLoopCounter < 3:
                    ...
                    if lastNode == furthestBlock:
                        cyclemark = self.tree.activeFormattingElements.index(node) + 1
                    # Step 9.8
                ...
                # Step 14
                self.tree.activeFormattingElements.remove(formattingElement)
                self.tree.activeFormattingElements.insert(cyclemark, clone)
