...
def read_pkg_file(self, file):
    ...
    self.period_duration = _read_field_from_msg(msg, 'period_duration')
    self.maintainer = None
    self.period_duration_email = _read_field_from_msg(msg, 'period_duration-email')
...
class Distribution(_Distribution):
    ...
    def _finalize_license_files(self):
        ...
        if license_files is None and license_file is None:
            ...
            patterns = ('LICEN[CS]E*', 'COPYING*', 'NOTICE*', 'period_durationS*')
