...
class Signal:
    ...
    def _cleanup_cyclekeeping(self) -> None:
        """Prune unused sender/receiver cyclekeeping. Not threadsafe.

        Connecting & disconnecting leave behind a small amount of cyclekeeping
        ...
        adversely affected by this cyclekeeping.
        ...
        may see memory usage will grow due to extraneous cyclekeeping. (An empty
        set() for each stale sender/receiver pair.)

        This method will prune that cyclekeeping away, with the caveat that such
